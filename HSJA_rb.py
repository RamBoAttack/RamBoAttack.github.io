...
class HSJA(object):
    def __init__(self,model,constraint='l2',num_iterations=50,gamma=1.0,stepsize_search='geometric_progression',max_num_evals=1e4,init_num_evals=100, verbose=True,delta=2,len_T=2000):
        self.model = model
